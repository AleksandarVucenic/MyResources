...
<table width="900">
	...
	<?php 
		...
		$totalCoefStatus = "#0066ff";	
		if($totalCoef != 1){ $totalCoefStatus = "#f00"; }
    ?>
	...
	<tr>
		...
		<td align="center"><!-- TODO: SET DELETE -->
			<a title="Delete" title="Delete" onclick="submitAjaxForm('/managetpc/risk/ajax/definition/riskTypeLogic.php?action=delete&riskTypeItemID=<?php echo $data->riskItemType; ?>', '', '', true, '', false); getRiskTypeTable('#riskTypeTable'); clearForm('#riskTypeForm'); hideIt('#riskTypeFormDiv');" >
	...
	<tr>
		<td></td>
		<td></td>
		<td align="center" style="background: <?php echo $totalCoefStatus; ?>; color: #fff"><strong style="margin-left: 10px;">TOTAL: </strong><?php echo $totalCoef; ?></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
